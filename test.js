...
// console.log(flex.invertBoolean(undefined));
// console.log(flex.invertBoolean([1,2,3]));
// console.log(flex.invertBoolean({name: 'anya', age: 21}));

let a = Symbol('abc')
//
// console.log(flex.stringifyValue([1, 2, 3]));
// console.log(flex.stringifyValue({name: 'anya', age: 21}) + 2);
...
// console.log(flex.convertToNumber('23dsfsdf'));
// console.log(flex.convertToNumber('-134.3'));
// console.log(flex.convertToNumber(undefined));
// console.log(flex.convertToNumber(NaN));
// console.log(flex.convertToNumber(null));
// console.log(flex.convertToNumber(true));
// console.log(flex.convertToNumber(false));
// console.log(flex.convertToNumber(''));
// console.log(flex.convertToNumber({name: 'anya', age: 21}));
// console.log(flex.convertToNumber([1,2,3]));
// console.log(flex.convertToNumber({}));
// console.log(flex.convertToNumber([]));
// console.log(flex.convertToNumber(a));
// console.log(flex.convertToNumber(a));
...
// console.log(flex.coerceToType(undefined, 'number'));
// console.log(flex.coerceToType(false, 'number'));
// console.log(flex.coerceToType(true, 'number'));
// console.log(flex.coerceToType([], 'number'));
// console.log(flex.coerceToType([], 'number'));
// console.log(flex.coerceToType({}, 'string'));
// console.log(flex.coerceToType([], 'string'));
// console.log(flex.coerceToType([1, 2, 3], 'string'));
